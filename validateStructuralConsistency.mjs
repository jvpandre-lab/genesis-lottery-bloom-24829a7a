 ...
 *
 * Validates:
 * 1. lotomania_draws history count and data integrity
 * 2. territoryEntropy NaN risk in territory.entropy()
 * 3. Backtest consistency: 10 draws vs max available
 * 4. recentResults flow from fetchRecentGenerations()
 * 5. Overall system stability objective validation
 */
...
const SUPABASE_URL =
  process.env.VITE_SUPABASE_URL || "https://yrvhazbjzkjhiywzzqim.supabase.co";
const SUPABASE_KEY =
  process.env.VITE_SUPABASE_ANON_KEY ||
  "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InlyhmhhamJemtramhpeXd6enFpbSIsInJvbGUiOiJhbm9uIiwiaWF0IjoxNzE5MzEwNjI5LCJleHAiOjE4NzcwNzY2Mjl9.HLYgrP2jhBfI_5j7EB6hE-Y9tGbTj9_3lkEYXWnkE1Y";
...
// ═══════════════════════════════════════════════════════════════════════════════
// Task 2: Validate territoryEntropy NaN risk
// ═══════════════════════════════════════════════════════════════════════════════
...
function validateTerritoryEntropyLogic() {
  ...
  for (const test of testCases) {
    try {
      ...
      console.log(`  ${isNaN ? "✗" : "✓"} ${test.name}: ${ent.toFixed(4)}`);
...
// ═══════════════════════════════════════════════════════════════════════════════
// Task 3: Compare backtest with 10 draws vs max available
// ═══════════════════════════════════════════════════════════════════════════════
...
// ═══════════════════════════════════════════════════════════════════════════════
// Task 4: Validate recentResults flow from fetchRecentGenerations()
// ═══════════════════════════════════════════════════════════════════════════════
